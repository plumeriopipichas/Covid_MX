...
write.csv(x = estimacion_decesos,file="csv_generados/estimacion_decesos.csv")
print("municipales")
write.csv(x = alto_positivo,file="csv_generados/municipales.csv")
print("acumulados")
write.csv(x = acumulados_varios_,file="csv_generados/acumulados_varios_DEP.csv")
print("reciente")
