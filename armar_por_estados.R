...
for (k in unique(datos_resumidos$Abreviatura)){
  ...
  decesos_registrados_edos[[k]]$desfase<-
    decesos_registrados_edos[[k]]$Dia_registro-
    as.integer(as.Date(decesos_registrados_edos[[k]]$FECHA_DEF)-as.Date("2020-04-11"))
  ...
  contados_recientes_edos[[k]]<-filter(decesos_registrados_edos[[k]],
                                       Dia_registro==d)
